// AUTO-EXTRACTED golden fixture from the original clustering.test.ts.
// Pins the clustering output that must stay identical across the WASM port.
/* eslint-disable */
export const inputValues: Record<string, number>[] = [
    {
